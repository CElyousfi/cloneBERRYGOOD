...
// =====================================================
//  Berry Good Farms - Recolte F5 (Myrtille Laaouamra)
//  Rendement moyen par Equipe - Ferme F5
// =====================================================

const FERME = 'F5';
const FERME_LABEL = 'F5 - Myrtille Laaouamra';
const FERME_COLOR_HEX = '#2D8B4E';
...
function buildWidget(data) {
  ...
  footer.addSpacer(3);
  addText(footer, 'Slider pour F1', Font.systemFont(8), C.dimmed);
