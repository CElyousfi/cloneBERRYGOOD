...
/**
 * gen-exemple-export-factures-v4.js — Génère docs/EXEMPLE-Export-Factures-TIMAC-25-26-v4.xlsx
 * à partir des factures TIMAC réelles (collection `invoices`), campagne juil 2025
 * → juin 2026.
 *
 * v4 — ÉTEND la règle mot-clé (TAXABLE_PRODUCT_PATTERNS) avec 6 familles
 * déduites par subset-sum et validées par le DG (FERTIACTYL, ECOVIGOR, SEACTIV,
 * RHIZO, KSC, SULFATE DE MAGNESIE). Garde-fou de réconciliation INCHANGÉ et
 * prioritaire : les factures dont Σ ne colle pas restent flaggées.
 *
 ...
 *
 * Usage : node scripts/gen-exemple-export-factures-v4.js
 */
...
const OUT = path.join(ROOT, 'docs', 'EXEMPLE-Export-Factures-TIMAC-25-26-v4.xlsx');
