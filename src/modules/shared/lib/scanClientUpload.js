 ...
 *   - ScanAttachmentUtils (pure path/entity helpers).
 *
 * 2026-06 — initial creation (brique scan unifiée, client-direct upload).
 */

import * as ScanAttachmentUtils from './scanAttachmentUtils.js';

var SCU_Utils = ScanAttachmentUtils;
...
export { isStorageAvailable, uploadDirect, uploadDirectToPath, recordAttachment, uploadAndRecord, getAttachmentUrl };
