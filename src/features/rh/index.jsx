...
export {
  ...
  KGHA_COLOR,
  totalOvertimeMin,
  handleImportDeclares,
  loadHS,
  saveBlocEdit,
  q,
  nbEnDepassement,
  kgStartCol,
  handleSyncIdentiteBdp,
  e,
  weeklyTrend,
  kpiTransport,
  dayNum,
