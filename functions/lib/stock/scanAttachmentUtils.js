 ...
 *   public/lib/scanAttachmentUtils.js (UMD front + node:test repo-root).
 * Cette copie existe car le package déployé des Cloud Functions n'embarque QUE
 * le dossier functions/ : un require('../../../public/lib/...') depuis le backend
 * throw "Cannot find module .../public/..." au runtime et casse TOUTES les
 * fonctions au chargement. Le backend ne doit JAMAIS dépendre de public/.
 * Toute évolution de la logique pure doit être répliquée des deux côtés.
 *
 * Loaded as a plain CommonJS module from the Cloud Function:
 *   - require('./scanAttachmentUtils') → module.exports
 *
