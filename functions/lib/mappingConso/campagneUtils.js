 ...
 *   public/lib/campagneUtils.js (UMD front + node:test repo-root).
 ...
 * "Cannot find module .../public/..." au runtime. Le backend ne dépend JAMAIS
 * de public/. Toute évolution de la logique pure doit être répliquée des 2 côtés.
 *
 * Loaded as a plain CommonJS module from the backend :
 *   - require('./campagneUtils') → module.exports
 *
