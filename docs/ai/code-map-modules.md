...
<!-- sourceFingerprint: sha256:bc4fb98af5d19021 -->
...
| src/modules/shared/lib/analytiqueUtils.js | opLabel, opKey, buildAnalytiquePivot, resolveGroupeFamille, resolveGbCode, buildAnalytiquePivotByFamille, GB_GROUPE_MAP, GROUPE_ORDER, GB_ORDER |
| src/modules/shared/lib/articleCategories.js | CATEGORIES_ARTICLE, LABEL_VIDE, SUFFIXE_HORS_LISTE, optionsCategorie, estCanonique |
| src/modules/shared/lib/articleSelect.js | cleIdentite, cleRecherche, ficheChoisissable, indexerCatalogue, filtrerEntrees, verdictChoix, lignesInvalides, ISSUE_CHOISI, ISSUE_EN_COURS, ISSUE_INCONNU, ISSUE_AMBIGU, ISSUE_VIDE |
| src/modules/shared/lib/authResilience.js | decideAuthState, isNewAppVersion, retryDelayMs |
| src/modules/shared/lib/bcScanMatch.js | VARIETY_ALIASES, CULTURE_TOKENS, normalizeLabel, extractSecteurs, extractVariete, extractCulture, aliasMatch, matchParcelle |
| src/modules/shared/lib/bdcReceptionUtils.js | computeDeliveryData, resolveDeliveryDataOrError, filterReceptionsForBdc, computeReceptionRowsWithReliquat, computeReceptionEcart, clampReceivedQty, buildReceptionCreatedMessage |
| src/modules/shared/lib/bdcWorkflow.js | DIRECT_DG_FARMS, requiresChefValidation, nextStatusOnSubmit, bypassReason, chefProfileForFerme |
| src/modules/shared/lib/caisseUtils.js | EXPENSE_TYPES, INCOME_TYPES, OP_EXPENSE_TYPES, OP_INCOME_TYPES, TRANSFER_TYPES, QUICK_PERIODS, QUICK_TYPES, ANOMALY_CODES, MONTANT_ANOMALY_THRESHOLD, DESCRIPTION_MIN_LENGTH, ANALYTIQUE_PLACEHOLDER, MONTANT_ATYPIQUE_FACTOR, MONTANT_ATYPIQUE_WINDOW_DAYS, MONTANT_ATYPIQUE_MIN_SAMPLE, DOUBLON_MAX_DATE_DELTA_DAYS, DOUBLON_LEVENSHTEIN_THRESHOLD, DOUBLON_DESC_PREFIX_LEN, DESCRIPTION_GENERIC_REGEX, BAHIA_MARKER, AVANCE_KEYWORD_REGEX, detectCaisseAnomalies, computeTotals, quickPeriodToDateRange, searchTransactions, filterByQuickType, AXE_NON_RENSEIGNE, filterByAxes, distinctAxeValues, detectAnomaliesBatch, extractBeneficiaire, aggregateAvances, COMPTE_CLIENT_PREFIX, isCompteClientCaisse, computeCompteClientTotals |
| src/modules/shared/lib/campagneBudgetPivot.js | indexBudgets, buildBudgetPivot, ecartCell |
| src/modules/shared/lib/campagneBudgetQuinzaine.js | quinzaineKey, quinzaineNum, optionsFromPeriodes, quinzaineCourante, quinzainePrecedente, quinzainesByLabel, trancheQuinzaine, realiseQuinzaine, decoreQuinzaine, pctPartsCellule, resteQuinzaineCellule, noteQuinzaine |
| src/modules/shared/lib/campagneExportUtils.js | SHEET_MAX, ROW_KIND, PERCENT_HEADER, BUDGET_HEADER, scopeNote, perHa, buildParcelleBudgetIndex, haLabel, numFmtFor, percentFmtFor, percentColumns, sumBudget, budgetScope, budgetCells, safeSheetName, buildSyntheseRows, buildSyntheseAoA, syntheseSheetCols, buildParcelleSheetRows, buildParcelleSheetAoA, parcelleSheetCols |
| src/modules/shared/lib/campagneParcelleQuinzaine.js | lignesParQuinzaine, periodesDe |
| src/modules/shared/lib/campagneProduction.js | BAREME_KG_PAR_JH, BAREME_DH_PAR_KG, kgParParcelle, vitesseRecolte, effortRecolte |
| src/modules/shared/lib/campagneRapprochement.js | chargeParQuinzaine, rapprocher |
| src/modules/shared/lib/campagneRythme.js | CLASSES, JOURS_CAMPAGNE, QUINZAINES_PAR_MOIS, FENETRE_PAR_DEFAUT, MIN_QUINZAINES_CONSOMMEES, quinzaineNum, totalQuinzaines, quinzainesInfo, indexClasses, classeOf, classeFamille, resteBudgetCellule, moyenneMobile, resteRythmeCellule, decoreRestes, noteRestes, partEcoulee, joursEcoules |
| src/modules/shared/lib/campagneUtils.js | campagneOf, campagneCourante, debutCampagne, finCampagne, campagneDeCharge, phaseDeCharge, mostRecentCampagne |
| src/modules/shared/lib/coutMainOeuvre.js | CATEGORIES, coutFeries, nbJoursDistincts, masseSalarialeNette, netAPayer, categorieMO, primeFonctionADate, joursParOuvrier, paieOuvrier, netParCategorie, chargesSociales, coutEmployeur, totalQuinzaine |
| src/modules/shared/lib/cultureUtils.js | CULTURES, normCulture, resolveCulture, matchesCulture |
| src/modules/shared/lib/emargementExcel.js | genSansCnssXlsx, genAvecCnssXlsx, genTransporteursXlsx, genBulletinsXlsx |
| src/modules/shared/lib/emargementPdf.js | genSansCnss, genAvecCnss, genTransporteurs, genBulletins, genBulletinsAr |
| src/modules/shared/lib/encaissementsCanevas.js | ENCAISSEMENTS_SCHEMA, round2, slugifyClient, normalizeReference, parseFrNumber, parseDate, parseEncaissements, buildModeleAoA, buildModeleWorkbook |
| src/modules/shared/lib/factureExportUtils.js | STANDARD_TVA_RATES, TVA_SNAP_EPS, CAMPAIGN_START_MONTH, TAXABLE_TVA_RATE, TAXABLE_PRODUCT_PATTERNS, ANOMALIE_TVA_B, INFO_TVA_NON_SAISIE, fxRound2, parseFactureDate, campaignBounds, isWithinPeriod, campaignYearOf, listAvailableCampaigns, reconciliationEpsilon, normalizeDesignation, matchProduitTaxable, deriveTauxLigne, parseSaisiTaux, resolveTauxLigne, deriveTauxTva, buildFactureLines, RECAP_COL, RECAP_NB_COLS, buildRecapStatutRows |
| src/modules/shared/lib/fusionMasse.js | docIdFiche, masterDuGroupe, doublonsDuGroupe, estSelectionnable, raisonNonSelectionnable, clesSelectionnables, construireLot, signatureLot, agregerApercu, resumerExecution |
| src/modules/shared/lib/growthUtils.js | FRAMBOISE_CULTURE, ALL_VARIETES, MAX_LENGTH_CM, framboiseParcelles, varietesFramboise, buildGrowthSeries, validateMeasurement, normalizeCheckpoints |
| src/modules/shared/lib/imageDownscale.js | computeTargetSize, downscaleToDataUrl |
| src/modules/shared/lib/inflightDedup.js | dedupInflight |
| src/modules/shared/lib/inventaireUtils.js | computeInventaireTotals, formatQteParUnite, boundedLedger |
| src/modules/shared/lib/lecturePaieExcel.js | normaliserLibelle, cleMatricule, estNombre, estLigneTotal, trouverEnTete, colonne, lireFeuilleOuvriers, periodeDeGrille, lireTransport, lireDivers, agregerOuvriers, postesExcel |
| src/modules/shared/lib/localTestBypass.js | installLocalTestBypass |
| src/modules/shared/lib/meteoCalc.js | saturationVaporPressure, vpdAt, computeHourlyVPD, computeCumRadiation, peakIndex |
| src/modules/shared/lib/paieDataCache.js | DEFAULT_TTL_MS, pointageKey, peek, set, getOrLoad, invalidate |
| src/modules/shared/lib/paieUtils.js | PAIE_BAREMES_DEFAULT, trouverPalierAnciennete, calculerPaieOuvrier, resolveSmagForDate, computeWorkerPaie, computePayslip |
| src/modules/shared/lib/parcelleGroupUtils.js | QTY_DECIMALS, round3, totalHa, computeParts, splitQuantite, formatApercu |
| src/modules/shared/lib/plafondDeclaration.js | bornesQuinzaine, plafondSurPeriode, plafondQuinzaine, repartir |
| src/modules/shared/lib/primesImportParse.js | normHeader, MATRICULE_ALIASES, PRIME_ALIASES, findHeaderRow, extractPrimesRows |
| src/modules/shared/lib/primesV2.js | norm, matches, searchWorkers, buildHistoryView |
| src/modules/shared/lib/quinzaineUtils.js | getEqPrefix, computeTransportQuinzaine |
| src/modules/shared/lib/rapprochementPaie.js | nombre, valeurFerieFichier, ligne, comparer, alertes |
| src/modules/shared/lib/recolteKpiUtils.js | aggregatePeriodKpis, computeNetDhParKg, computeNetDhParKgProd, distinctOuvriersFromRows |
| src/modules/shared/lib/scanAttachmentUtils.js | ENTITY_MAP, ALLOWED_EXTENSIONS, isValidEntityType, collectionForEntity, folderForEntity, extOf, mimeFromFilename, sanitizeFilename, buildScanPath, isScanPathForEntity, validateUploadAttachmentParams |
| src/modules/shared/lib/scanClientUpload.js | isStorageAvailable, uploadDirect, uploadDirectToPath, recordAttachment, uploadAndRecord, getAttachmentUrl |
| src/modules/shared/lib/scanHistoryDisplay.js | scanFournisseurLabel, scanTtc, scanBdcMatche |
| src/modules/shared/lib/stockDestinations.js | resolveDestinationOptions, resolveReceptionDestination, resolveBdcDestination, SD_HORS_CONFIG_SUFFIX, SD_NOTE_HORS_CONFIG, SD_FERMES_STOCK_NON_MUTUALISE |
| src/modules/shared/lib/stockMovementGuard.js | IMPORT_CREATED_BY, VALIDATED_STATUS, isImportedMovement, isValidatedMovement, isDeletedMovement, isCreator, evaluateMutable, canEditMovement, canDeleteMovement, ADMIN_DELETE_ROLES, isAdminDeleter, evaluateAdminDelete, canAdminDeleteMovement, refusalMessage |
| src/modules/shared/lib/uniteConsoUtils.js | CHAMP_UNITE_CONSOMMATION, CHAMP_FACTEUR, MOTIFS, normaliserUnite, lireFacteur, uniteStock, uniteConsommation, unitesSaisissables, phraseConversion, convertirQuantite, canonNom, indexerArticles, trouverArticle, estAmbigu, analyserLignes |
| src/modules/shared/lib/useStockLocations.js | useStockLocations, deriveStockLocations, USL_FALLBACK_MAGASINS |
