...
| primesConfig | ParametresTab.jsx, ChargementSub.jsx, PrimesRecapSub.jsx, JourFerieSub.jsx, PaieTab.jsx, PointageTab.jsx, QuinzainePopupGenerique.jsx, QuinzaineTab.jsx, DashboardTab.jsx | `joursFeries` **câblé** (2026-09-14) sur `app_settings/jours_feries` (43 fériés réels, 2025+2026, via `/api/pointage-validation?action=jours-feries`). Le reste (tranches de primes, `primeCaporal`, `primeChargement`) : pas de source Firestore trouvée. | **partiellement réel** | `joursFeries` réel ; tranches/primeCaporal/primeChargement toujours hardcoded — **plus large impact** (9 écrans) si un jour câblés. |
