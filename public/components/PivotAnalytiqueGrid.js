...
(function () {
  ...
  function PivotAnalytiqueGrid(props) {
    ...
    if (largeursFixes) {
      ...
      tableStyle.minWidth = LARGEUR_LIBELLE + (parcelles.length + (showTotal ? 1 : 0)) * largeurColonne;
    }
    ...
    var totalHa = typeof props.totalHa === 'number' && props.totalHa >= 0 ? props.totalHa : parcelles.reduce(function (s, p) {
      return s + p[1];
    }, 0);
    ...
    _pag_h('thead', null, _pag_h('tr', {
      ...
      if (onParcelleClick) {
        ...
        attrsEntete.onClick = function (cle, ha) {
          return function () {
            onParcelleClick(cle, ha);
          };
        }(p[0], p[1]);
      }
      attrsEntete.style = styleEntete;
      return _pag_h('th', attrsEntete, _pag_h('div', {
        style: {
          color: color,
          fontWeight: 700,
      ...
      return metrics.map(function (m, i) {
        return _pag_h('th', {
          ...
          style: {
            ...
            minWidth: largeursFixes ? undefined : 70,
            whiteSpace: 'nowrap',
            borderRight: borderSousColonne(i)
          }
