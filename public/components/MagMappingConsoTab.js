...
(function () {
  ...
  function mmcIsCovered(s) {
    return MMC_COVERED.indexOf(s) !== -1;
  }
  function mmcIsPending(s) {
    return MMC_PENDING.indexOf(s) !== -1;
  }

  // Regroupement avocatier par ferme — info card, AUCUN mapping (cf. seed).
  var MMC_AVOCADO_FARMS = [{
    ferme: 'F2',
    varietes: 'Haas · Bacon · Zutano'
  }, {
    ferme: 'F3',
    varietes: 'Haas · Fuerte · Zutano'
  }, {
    ferme: 'F4',
    varietes: 'Haas · Fuerte · Zutano'
  }, {
    ferme: 'F6',
    varietes: 'Haas · Bacon · Fuerte · Zutano'
  }];
  var MMC_FILTERS = [{
    key: 'all',
    label: 'Tous'
  ...
  function mmcFmtRepartition(rep) {
    ...
    return rep.map(function (p) {
      return p.cible + ' ' + p.pct + '%';
    }).join(' · ');
  }
  var MMC_th = {
    padding: '8px 6px',
  ...
  var MMC_selectStyle = {
    height: 36,
    padding: '0 12px',
    border: '1px solid ' + MMC_C.border,
    borderRadius: 8,
    background: MMC_C.surface,
    fontSize: 14,
    color: MMC_C.textPrimary,
    minWidth: 190
  };
  var MMC_inputStyle = {
    height: 30,
    padding: '0 8px',
    border: '1px solid ' + MMC_C.borderStrong,
    borderRadius: 6,
    fontSize: 12,
    minWidth: 180
  };
  function mmcBtn(variant) {
    ...
    return {
      ...
      color: solid ? '#fff' : MMC_C.textPrimary,
      whiteSpace: 'nowrap'
    };
  }
  function mmcChip(active) {
    return {
      ...
      background: active ? MMC_C.surface3 : MMC_C.surface,
      color: MMC_C.textPrimary
    };
  }
  function MMC_Kpi(props) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontWeight: 500,
        margin: '4px 0 0',
        color: props.color || MMC_C.textPrimary
      }
    }, props.value));
  }
  ...
  function MappingConsoTab(props) {
    ...
    useEffect(function () {
      ...
      var unsub = db.collection('parcelles_consommation').onSnapshot(function (snap) {
        var map = {};
        ...
        setErr(e && e.message || 'Erreur parcelles_consommation');
      });
      return unsub;
    }, []);
    ...
    useEffect(function () {
      setLoading(true);
      var db = firebase.firestore();
      var unsub = db.collection('mapping_campagne').where('campagne', '==', campaign).onSnapshot(function (snap) {
        var rows = [];
        snap.forEach(function (d) {
          var data = d.data() || {};
          rows.push({
        ...
        setErr(e && e.message || 'Erreur mapping_campagne');
        setLoading(false);
      });
      return unsub;
    }, [campaign]);
    ...
    var k = useMemo(function () {
      var covered = rows.filter(function (r) {
        return mmcIsCovered(r.statut);
      }).length;
      var pending = rows.filter(function (r) {
        return mmcIsPending(r.statut);
      }).length;
      var aliasToValidate = rows.filter(function (r) {
        return r.statut === 'alias_propose';
      }).length;
      var toCreate = rows.filter(function (r) {
        return r.statut === 'a_creer';
      }).length;
      var hors = rows.filter(function (r) {
        return MMC_STATUS[r.statut] && MMC_STATUS[r.statut].group === 'hors';
      }).length;
      var total = rows.length;
      var resolvedPct = total ? Math.round((total - pending) / total * 100) : 0;
      return {
        covered: covered,
        aliasToValidate: aliasToValidate,
        toCreate: toCreate,
        hors: hors,
        total: total,
    ...
    var segs = useMemo(function () {
      ...
      var coveredN = rows.filter(function (r) {
        return mmcIsCovered(r.statut);
      }).length;
      var aliasN = rows.filter(function (r) {
        return r.statut === 'alias_propose';
      }).length;
      var creerN = rows.filter(function (r) {
        return r.statut === 'a_creer';
      }).length;
      var horsN = rows.filter(function (r) {
        return r.statut === 'hors_propose';
      }).length;
      return [{
        c: MMC_C.green,
        w: coveredN / total * 100
      }, {
        c: MMC_C.amber,
        w: aliasN / total * 100
      }, {
    ...
    function confirmPerimetre(id) {
      return mmcApi('confirm-perimetre', {
        docId: id
      }).catch(mmcFail);
    }
    ...
    function saveTarget(id) {
      mmcApi('reassign', {
        docId: id,
        cible_parcelle_culturale: draftTarget
      }).catch(mmcFail);
      setEditing(null);
    }
    ...
    function actionsFor(r) {
      ...
      var reassign = r.repartition ? /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: 11,
          color: MMC_C.textTertiary
        },
        title: "\xC9dition des % non disponible en V1"
      }, "R\xE9partition fig\xE9e") : /*#__PURE__*/React.createElement("button", {
        style: mmcBtn(),
        onClick: function () {
          setEditing(r.id);
          setDraftTarget(r.cible || '');
        }
      }, "R\xE9affecter");
      switch (r.statut) {
        case 'alias_propose':
        ...
        case 'hors_propose':
          return /*#__PURE__*/React.createElement("span", {
            ...
            style: mmcBtn('solid'),
            onClick: function () {
              confirmPerimetre(r.id);
            }
          }, "Confirmer p\xE9rim\xE8tre"), reassign);
        case 'alias_valide':
        case 'creee':
        case 'hors_confirme':
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Mapping parcelles de consommation"), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 13,
        color: MMC_C.textSecondary,
        margin: '2px 0 0'
      }
    }, "Univers magasinier \u2192 r\xE9f\xE9rentiel BEE ONE")), /*#__PURE__*/React.createElement("select", {
      value: campaign,
      onChange: function (e) {
    ...
    }, "Chargement du mapping\u2026") : rows.length === 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        background: MMC_C.surface2,
        borderRadius: 12,
        padding: '48px 24px',
    ...
    }, "Aucun mapping pour la campagne ", campaign), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 13,
        color: MMC_C.textSecondary,
        margin: '6px 0 16px'
      }
    }, "Le mapping se rejoue \xE0 chaque campagne. L'import \xE9crit le r\xE9f\xE9rentiel + le mapping via la Cloud Function (idempotent)."), /*#__PURE__*/React.createElement("button", {
      style: mmcBtn('solid'),
      onClick: seedCampagne
    }, "Importer les demandes magasinier")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
    ...
    }, /*#__PURE__*/React.createElement(MMC_Kpi, {
      label: "Parcelles conso",
      value: k.total
    }), /*#__PURE__*/React.createElement(MMC_Kpi, {
      label: "Valid\xE9es",
      value: k.covered,
      ...
      label: "Alias \xE0 valider",
      value: k.aliasToValidate,
      color: MMC_C.amber
    }), /*#__PURE__*/React.createElement(MMC_Kpi, {
      label: "\xC0 cr\xE9er",
      value: k.toCreate,
    ...
    }, "Mapping r\xE9solu"), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 13,
        fontWeight: 500
      }
    }, k.resolvedPct, "%")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        height: 10,
        borderRadius: 999,
        overflow: 'hidden',
        background: MMC_C.surface3,
        marginBottom: 20
      }
      ...
      style: {
        textAlign: 'left',
        color: MMC_C.textSecondary,
        borderBottom: '1px solid ' + MMC_C.borderStrong
      }
    }, /*#__PURE__*/React.createElement("th", {
      style: MMC_th
    }, "Parcelle de consommation"), /*#__PURE__*/React.createElement("th", {
      style: MMC_th
    }, "Famille"), /*#__PURE__*/React.createElement("th", {
      style: Object.assign({}, MMC_th, {
        textAlign: 'right'
      })
    }, "Pointages"), /*#__PURE__*/React.createElement("th", {
      style: MMC_th
    }, "Cible BEE ONE"), /*#__PURE__*/React.createElement("th", {
      style: MMC_th
    }, "Statut"), /*#__PURE__*/React.createElement("th", {
      style: MMC_th
    }, "Action"))), /*#__PURE__*/React.createElement("tbody", null, visible.map(function (r) {
      var st = MMC_STATUS[r.statut] || {
        label: r.statut,
        bg: MMC_C.surface3,
        fg: MMC_C.textSecondary
      };
      return /*#__PURE__*/React.createElement("tr", {
        key: r.id,
        style: {
          borderBottom: '1px solid ' + MMC_C.border
        }
      }, /*#__PURE__*/React.createElement("td", {
        style: MMC_td
      }, r.libelle), /*#__PURE__*/React.createElement("td", {
        style: Object.assign({}, MMC_td, {
          color: MMC_C.textSecondary
        })
      }, r.famille), /*#__PURE__*/React.createElement("td", {
        style: Object.assign({}, MMC_td, {
          textAlign: 'right',
          color: MMC_C.textSecondary,
          fontVariantNumeric: 'tabular-nums'
        })
      }, mmcFmt(r.pointages)), /*#__PURE__*/React.createElement("td", {
        style: Object.assign({}, MMC_td, {
          color: MMC_C.textSecondary
        })
      }, r.repartition ? mmcFmtRepartition(r.repartition) : r.cible || '—', r.note ? /*#__PURE__*/React.createElement("span", {
        style: {
          display: 'block',
          fontSize: 11,
          color: MMC_C.textTertiary
        }
      }, r.note) : null), /*#__PURE__*/React.createElement("td", {
        style: MMC_td
      }, /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: 12,
    ...
    }, "Avocatier \u2014 regroupement par ferme"), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 13,
        color: MMC_C.textSecondary,
        margin: '0 0 12px'
      }
    }, "Chaque demande \xAB Avocatier Fx \xBB cible toutes les vari\xE9t\xE9s brutes de la ferme. Charges non ventil\xE9es par vari\xE9t\xE9."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
      ...
      }, a.ferme), ' ', /*#__PURE__*/React.createElement("span", {
        style: {
          color: MMC_C.textSecondary,
          fontSize: 12
        }
