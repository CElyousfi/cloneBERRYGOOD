  ...
  function AffectationAnalytiqueTable(props) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, analytiqueDetailCell && (() => {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, _culturesWithData.length > 1 && /*#__PURE__*/React.createElement("div", {
        ...
        const _fmt = (val, ha) => {
          if (!analytiqueTotalMode && ha === 0) return /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: 10,
              color: 'var(--gray-400)'
            }
          ...
          if (analytiqueTotalMode) {
            return analytiqueView === 'jh' ? (Math.round(val * 10) / 10).toFixed(1) : Math.round(val).toLocaleString('fr-FR');
          }
          const v = val / ha;
          return analytiqueView === 'jh' ? (Math.round(v * 10) / 10).toFixed(1) : Math.round(v).toLocaleString('fr-FR');
        };
        return /*#__PURE__*/React.createElement("div", {
          key: culture,
          style: {
        ...
        }, culture), /*#__PURE__*/React.createElement("span", {
          style: {
            fontSize: 11,
            color: 'var(--gray-500)',
            fontWeight: 400
          }
        }, parcelles.length, " parcelle", parcelles.length > 1 ? 's' : '', _totalHa > 0 ? ` · ${_totalHa.toFixed(2)} Ha total` : '')), /*#__PURE__*/React.createElement("div", {
          style: {
            overflowX: 'auto'
          }
        }, /*#__PURE__*/React.createElement("table", {
        ...
        }, "Op\xE9ration"), parcelles.map(([pKey, ha]) => /*#__PURE__*/React.createElement("th", {
          key: pKey,
          style: {
            padding: '6px 10px',
            textAlign: 'center',
        ...
        }, (typeof prettyParcelle === 'function' ? prettyParcelle(pKey) : pKey) || pKey), /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 10,
            color: 'var(--gray-400)',
            fontWeight: 400
          }
        }, ha > 0 ? `${ha} Ha` : 'Ha ?'))), /*#__PURE__*/React.createElement("th", {
          style: {
            padding: '6px 10px',
            textAlign: 'center',
            fontWeight: 700,
        ...
        }, "Total"))), /*#__PURE__*/React.createElement("tbody", null, (groupedRows || []).map(row => {
          const _totalHaForRow = parcelles.reduce((s, [, ha]) => s + ha, 0);
          const _rowTotal = analytiqueView === 'jh' ? parcelles.reduce((s, [pKey]) => {
            const c = row.pivot[pKey];
            return s + (c ? c.jh : 0);
          }, 0) : parcelles.reduce((s, [pKey]) => {
            const c = row.pivot[pKey];
            return s + (c ? c.cout : 0);
          }, 0);
        ...
        }, "TOTAL"), parcelles.map(([pKey, ha]) => {
          const colTotal = analytiqueView === 'jh' ? (groupedRows || []).filter(r => r.type === 'famille').reduce((s, r) => {
            const c = r.pivot[pKey];
            return s + (c ? c.jh : 0);
          }, 0) : (groupedRows || []).filter(r => r.type === 'famille').reduce((s, r) => {
            const c = r.pivot[pKey];
            return s + (c ? c.cout : 0);
          }, 0);
          return /*#__PURE__*/React.createElement("td", {
          ...
          }, /*#__PURE__*/React.createElement("div", null, _fmt(colTotal, ha)), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 10,
              opacity: 0.7
            }
          ...
          const gt = analytiqueView === 'jh' ? (groupedRows || []).filter(r => r.type === 'famille').reduce((s, r) => s + parcelles.reduce((ps, [pKey]) => {
            const c = r.pivot[pKey];
            return ps + (c ? c.jh : 0);
          }, 0), 0) : (groupedRows || []).filter(r => r.type === 'famille').reduce((s, r) => s + parcelles.reduce((ps, [pKey]) => {
            const c = r.pivot[pKey];
            return ps + (c ? c.cout : 0);
          }, 0), 0);
          return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, _fmt(gt, _totalHa)), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 10,
              opacity: 0.7
            }
