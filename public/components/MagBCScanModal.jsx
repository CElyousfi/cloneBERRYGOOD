  ...
  function MagBCScanModal({
    ...
    return (
      <div className="modal-overlay" style={{ zIndex: 9999 }}>
        ...
        {/* Doublon refusé par create-bc (409). Garde explicite sur le global :
            une référence nue crasherait TOUT le modal si le script n'est pas
            chargé (cf. crashes #200). */}
        {doublonScan && window.BCDoublonDialog && (
          <window.BCDoublonDialog doublon={doublonScan} saving={saving}
