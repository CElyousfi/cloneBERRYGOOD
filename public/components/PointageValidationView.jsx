...
//
// IIFE → window.PointageValidationView (pattern composant séparé, pas de Vite).
(function () {
  ...
  function PointageValidationView(props) {
    ...
    var PointageTab = window.PointageTab;
    if (!PointageTab) {
  ...
  window.PointageValidationView = PointageValidationView;
})();
