...
(function () {
  ...
  function PivotView(props) {
    ...
    var partIdeale = useMemo(function () {
      ...
      return CR.partEcoulee({ campagne: data.campagne, utils: window.CampagneUtils });
    }, [CR, data.campagne]);
     ...
     */
    var facteurCharge = (props.coutOuvrier && Number(props.coutOuvrier.facteurCharge) > 0)
      ? Number(props.coutOuvrier.facteurCharge)
      : null;
    ...
    var noteCoutCharge = (isJh || facteurCharge === null) ? '' :
      ' Coût CHARGÉ : le salaire de base enregistré, majoré des primes et des '
      + 'charges réellement payées sur la campagne (× '
      + (Math.round(facteurCharge * 100) / 100).toLocaleString('fr-MA')
      + '). Réalisé et budget sont ainsi dans la même unité — sans cette '
      + 'majoration, une dépense hors charges serait comparée à un budget chargé.';
