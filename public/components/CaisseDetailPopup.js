...
(function () {
  ...
  function CDP_Colonne({
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, bons.length), /*#__PURE__*/React.createElement("span", {
      style: {
        marginLeft: 'auto',
        fontSize: 16,
        fontWeight: 800,
    ...
    }, signe, CDP_mad(total))), /*#__PURE__*/React.createElement("div", {
      style: {
        maxHeight: 320,
        overflowY: 'auto',
        marginTop: 8
      }
    }, bons.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        padding: '18px 4px',
        fontSize: 12,
        color: 'var(--gray-400)',
      ...
      }, t.description || t.reference || '—'), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 10.5,
          color: 'var(--gray-400)',
          marginTop: 1
        }
      }, t.date, t.code_analytique ? ` · ${t.code_analytique}` : '', t.ferme ? ` · ${t.ferme}` : '')), /*#__PURE__*/React.createElement("div", {
        style: {
          textAlign: 'right',
          whiteSpace: 'nowrap'
        }
      ...
      }, signe, CDP_mad(t.montant)), t.status !== 'valide' && /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: 9.5,
          padding: '1px 6px',
          borderRadius: 8,
  ...
  function CaisseDetailPopup({
    ...
    const tous = (Array.isArray(transactions) ? transactions : []).filter(t => t && t.caisse_id === caisse.id && CDP_STATUTS_EN_CAISSE.indexOf(t.status) !== -1).filter(t => inclureEnAttente || t.status === 'valide').slice().sort((a, b) => String(b.date || '').localeCompare(String(a.date || '')));
    ...
    const bloc = (label, valeur, couleur) => /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 10,
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }), caisse.nom || caisse.id), /*#__PURE__*/React.createElement("button", {
      onClick: onClose,
      "aria-label": "Fermer",
      style: {
        background: 'none',
    ...
    }), "Inclure les bons saisis non encore valid\xE9s", nbEnAttente > 0 && inclureEnAttente && /*#__PURE__*/React.createElement("span", {
      style: {
        color: 'var(--orange)',
        fontWeight: 600
      }
    }, "(", nbEnAttente, ")")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 20,
        flexWrap: 'wrap',
    ...
    }, bloc('Solde initial', CDP_mad(soldeInitial)), /*#__PURE__*/React.createElement("span", {
      style: {
        color: 'var(--gray-400)'
      }
    }, "+"), bloc('Alimentations', CDP_mad(totalIn), 'var(--green)'), /*#__PURE__*/React.createElement("span", {
      style: {
        color: 'var(--gray-400)'
      }
    }, "\u2212"), bloc('Décaissements', CDP_mad(totalOut), 'var(--red)'), /*#__PURE__*/React.createElement("span", {
      style: {
        color: 'var(--gray-400)'
      }
    }, "="), /*#__PURE__*/React.createElement("div", {
    ...
    }, inclureEnAttente ? 'Solde en caisse' : 'Solde validé'), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 22,
        fontWeight: 800,
        color: soldeFinal < 0 ? 'var(--red)' : 'var(--berry)'
      }
    }, CDP_mad(soldeFinal)))), soldeFinal < 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 8,
        alignItems: 'flex-start',
    ...
    }), /*#__PURE__*/React.createElement("span", null, "Solde n\xE9gatif : les alimentations de cette caisse n'ont pas encore \xE9t\xE9 saisies.")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 24,
        flexWrap: 'wrap'
      }
    }, /*#__PURE__*/React.createElement(CDP_Colonne, {
      titre: "Alimentations",
      icone: "fa-arrow-down",
      couleur: "var(--green)",
      bons: alimentations,
      ...
      titre: "D\xE9caissements",
      icone: "fa-arrow-up",
      couleur: "var(--red)",
      bons: decaissements,
      total: totalOut,
      signe: "\u2212",
      vide: "Aucun d\xE9caissement."
    }))));
  }
