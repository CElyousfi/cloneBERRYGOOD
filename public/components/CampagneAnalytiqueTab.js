...
(function () {
  ...
  function ConsoView(props) {
    ...
    }, 'Leurs quantités ne sont comptées dans AUCUN des deux onglets. ' + 'Corrigez la catégorie de ces articles dans le catalogue (Stock › Articles) : ' + 'la correction vaut pour tout l\'historique, sans ressaisir les bons.'), React.createElement('ul', {
      style: {
        margin: 0,
        paddingLeft: '18px'
      }
