...
(function () {
  ...
  function PivotView(props) {
    ...
    enQuinzaine ? React.createElement('select', {
    ...
    }, 'Aucune donnée pour cette sélection.') : groups.map(function (g) {
      ...
      return React.createElement(Grid, {
        key: g.culture,
        parcelles: pivot.parcelles,
        groupedRows: quinz ? quinz.groupedRows : res ? res.groupedRows : sup ? sup.groupedRows : pivot.groupedRows,
        metrics: quinz ? metricsQuinzaine : res ? metricsRestes : sup && sup.hasBudget ? metricsBudget : metrics,
        ...
        note: quinz ? CBQ.noteQuinzaine(quinzaineInfoSel || {
          key: quinzaineActive
        }, quinzaineActive === quinzaineCourante) : res ? CR.noteRestes(res.perimetre, quinzaines) : sup && sup.hasBudget ? noteBudgetSeul : null,
        color: g.color,
        title: g.culture,
        icon: g.icon,
