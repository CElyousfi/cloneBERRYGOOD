...
(function () {
  ...
  function StatusBadge(props) {
    var meta = STATUS_META[props.status] || {
      label: props.status || '?',
      color: '#444',
      bg: '#eee'
    };
  ...
  function BugReportsAdminComponent(props) {
    ...
    if (loading) {
      ...
      content = React.createElement('div', {
        ...
        }, photoThumb, React.createElement('div', {
          style: {
            flex: '1 1 240px',
            minWidth: '240px',
            display: 'flex',
    ...
    var zoomOverlay = zoom ? React.createElement('div', {
      onClick: function () {
        setZoom(null);
      },
      style: {
