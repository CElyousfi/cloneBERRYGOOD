 ...
 * UMD bricolé (window + module.exports), comme public/lib/caisseUtils.js.
 */
// @ts-check
(function () {
  'use strict';
  ...
  var __api = {
    cleIdentite: cleIdentite,
    cleRecherche: cleRecherche,
    ficheChoisissable: ficheChoisissable,
    indexerCatalogue: indexerCatalogue,
    filtrerEntrees: filtrerEntrees,
    verdictChoix: verdictChoix,
    lignesInvalides: lignesInvalides,
    ISSUE_CHOISI: ISSUE_CHOISI,
    ISSUE_EN_COURS: ISSUE_EN_COURS,
    ISSUE_INCONNU: ISSUE_INCONNU,
    ISSUE_AMBIGU: ISSUE_AMBIGU,
    ISSUE_VIDE: ISSUE_VIDE,
  };

  if (typeof module !== 'undefined' && module.exports) module.exports = __api;
  if (typeof window !== 'undefined') window.ArticleSelect = __api;
