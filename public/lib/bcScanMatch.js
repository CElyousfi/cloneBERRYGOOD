 ...
 *
 * Chargé en <script src="lib/bcScanMatch.js"> classique : PARTAGE LE SCOPE
...
(function () {
   ...
   * window.CultureUtils, source de vérité du repo (cf. cultureOfOption).
   */
  ...
  /**
   * Culture d'une OPTION, déléguée à window.CultureUtils (source de vérité du
  ...
  function cultureOfOption(o) {
    var CU = (typeof window !== 'undefined' && window.CultureUtils) || null;
  ...
  var __bcScanMatchApi = {
    VARIETY_ALIASES: BCSM_VARIETY_ALIASES,
    CULTURE_TOKENS: BCSM_CULTURE_TOKENS,
  ...
  if (typeof window !== 'undefined') window.BcScanMatch = __bcScanMatchApi;
  if (typeof module !== 'undefined' && module.exports) module.exports = __bcScanMatchApi;
})();
