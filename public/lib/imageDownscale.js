 ...
 *
 * Chargé en <script src="lib/imageDownscale.js"> classique : PARTAGE LE SCOPE
...
(function () {
  ...
  var __imageDownscaleApi = {
    computeTargetSize: computeTargetSize,
    downscaleToDataUrl: downscaleToDataUrl,
  };

  if (typeof window !== 'undefined') window.ImageDownscale = __imageDownscaleApi;
  if (typeof module !== 'undefined' && module.exports) module.exports = __imageDownscaleApi;
})();
