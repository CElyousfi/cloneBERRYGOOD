...
(function () {
  ...
  var api = {
    ...
    LABEL_VIDE: LABEL_VIDE,
    SUFFIXE_HORS_LISTE: SUFFIXE_HORS_LISTE,
    optionsCategorie: optionsCategorie,
    estCanonique: estCanonique,
  };

  // UMD maison (cf. public/lib/caisseUtils.js). L'IIFE évite toute collision de
  // nom top-level dans le scope global du navigateur : les scripts classiques
  // de public/lib/ le partagent, et un doublon y crashe le boot React (#200).
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
  if (typeof window !== 'undefined') window.ArticleCategories = api;
})();
