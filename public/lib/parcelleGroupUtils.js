 ...
 *
 * Chargé deux fois :
 *   - navigateur via <script src="lib/parcelleGroupUtils.js"> → window.ParcelleGroupUtils
 *   - node:test via require('./parcelleGroupUtils.js') → module.exports
 *
 ...
 * les rares symboles internes sont préfixés `PGU_` → aucune collision possible
 * avec app.jsx ou un autre public/lib/*.js (cf. crash React #200 connu).
 */
// @ts-check
'use strict';
...
(function () {
  ...
  var PGU_api = {
    QTY_DECIMALS: PGU_QTY_DECIMALS,
    round3: PGU_round3,
    totalHa: PGU_totalHa,
    computeParts: PGU_computeParts,
    splitQuantite: PGU_splitQuantite,
    formatApercu: PGU_formatApercu,
  };

  if (typeof module !== 'undefined' && module.exports) module.exports = PGU_api;
  if (typeof window !== 'undefined') window.ParcelleGroupUtils = PGU_api;
})();
