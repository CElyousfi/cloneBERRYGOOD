 ...
 *
 * Loaded twice:
 *   - In the browser via <script src="lib/primesV2.js"> → window.PrimesV2
 *   - In node:test via require('./primesV2.js') → module.exports
 *
...
// in an IIFE keeps everything local and exposes ONLY window.PrimesV2.
