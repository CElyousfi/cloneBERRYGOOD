 ...
 *   window.CampagneParcelleQuinzaine
 *
 * ── À QUOI ÇA SERT ─────────────────────────────────────────────────────────
...
(function () {
  ...
  var __campagneParcelleQuinzaineApi = {
    lignesParQuinzaine: lignesParQuinzaine,
    periodesDe: periodesDe,
  };

  if (typeof module !== 'undefined' && module.exports) module.exports = __campagneParcelleQuinzaineApi;
  if (typeof window !== 'undefined') window.CampagneParcelleQuinzaine = __campagneParcelleQuinzaineApi;
