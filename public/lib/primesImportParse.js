 ...
 *
 * Loaded twice:
 *   - In the browser via <script src="lib/primesImportParse.js"> → window.PrimesImportParse
 *   - In node:test via require('./primesImportParse.js') → module.exports
 *
...
// in an IIFE keeps everything local and exposes ONLY window.PrimesImportParse.
// See MEMORY: umd-global-collision-smoke-load.
(function (root, factory) {
    var api = factory();
    if (typeof module !== 'undefined' && module.exports) module.exports = api;
    if (root) root.PrimesImportParse = api;
    ...
    return {
        ...
        MATRICULE_ALIASES: MATRICULE_ALIASES,
        PRIME_ALIASES: PRIME_ALIASES,
        findHeaderRow: findHeaderRow,
        extractPrimesRows: extractPrimesRows,
    };
});
